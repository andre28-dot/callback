...
const generarSaludo = (nombre, nombre2, universidad = "UNIVO") => {
...
const saludo1 = generarSaludo(nombre1);
console.log(saludo1);
//Solicitamos al usuario que ingrese un segundo nombre
const nombre2 = prompt("Ingrese el segundo nombre (opcional): ");
const saludo2 = generarSaludo(nombre1, nombre2);
console.log(saludo2);
